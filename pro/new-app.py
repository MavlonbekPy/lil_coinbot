...
async def main(page: ft.Page) -> None:
    ...
    # Coin image
    coin_image = ft.Image(
        src="https://i.ibb.co/0VRYCN9/lacoin.png",  # Убедитесь, что путь к изображению корректен
        fit=ft.ImageFit.CONTAIN,
        scale=1.0,
        width=300,  # Задайте ширину
        height=300  # Задайте высоту
    )
    ...
    # Text displaying progress in percentage
    ...
    async def score_up(event: ft.ContainerTapEvent) -> None:
        ...
        progress_text.value = f"{int(progress_value * 100)}%"  # Update percentage text
    ...
    click_container = ft.Container(
        content=coin_image,
        on_click=score_up,
        width=320,  # Убедитесь, что контейнер больше изображения
        height=320,
    ...
    page.add(
        ft.Column(
            controls=[
                ...
                progress_text,  # Adding progress text under or above the bar
